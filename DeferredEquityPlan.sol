...
contract DeferredEquityPlan {
    //This was line of code to do time unlock testing using fakenow
    //uncomment these items to test logic locally
    // to use this all instance of now must be replaced with fakenow 
    //uint fakenow = now;
    ...
    //use this function and uncomment it to test fakenow process used to test logic for timestep unlock
